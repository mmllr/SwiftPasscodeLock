...
open class PasscodeLockPresenter {
    ...
    open func presentPasscodeLock() {
        ...
        passcodeLockWindow.windowLevel = .init(2)
        ...
        if animated {
            UIView.animate(
                ...
                completion: { [weak self] _ in
                    ...
                    self?.passcodeLockWindow.windowLevel = .init(0)
            ...
            passcodeLockWindow.windowLevel = .init(0)
